...
// node_modules/vuejs-smart-table/node_modules/vue-demi/lib/index.esm.js
var isVue2 = false;
function install() {
}

// node_modules/vuejs-smart-table/dist/vuejs-smart-table.es.js
var t;
var e;
...
var i = (t2, e2) => {
  for (var s2 in e2 || (e2 = {})) a.call(e2, s2) && o(t2, s2, e2[s2]);
  if (r) for (var s2 of r(e2)) l.call(e2, s2) && o(t2, s2, e2[s2]);
  return t2;
};
function m(t2, e2) {
...
function C(t2, e2) {
  ...
  }(e2) && !e2.custom(e2.value, t2)) return false;
  if (!function(t3) {
    return Array.isArray(t3.keys);
  }(e2) || null === e2.value || void 0 === e2.value || 0 === e2.value.length) return true;
  for (const s2 of e2.keys) {
    const a2 = m(t2, s2);
    if (null != a2) {
      const t3 = Array.isArray(e2.value) ? e2.value : [e2.value];
      for (const s3 of t3) if (e2.exact) {
        if (a2.toString() === s3.toString()) return true;
      } else if (a2.toString().toLowerCase().includes(s3.toString().toLowerCase())) return true;
    }
  }
  return false;
}
...
var R = class {
  constructor(e2) {
    this.state = reactive({ data: [], filters: {}, selectedRows: [], selectionMode: "single", selectOnClick: true, selectedClass: "", hideSortIcons: false, sortId: null, sortKey: null, customSort: null, sortOrder: t.NONE, currentPage: 0, pageSize: void 0, sortIconPosition: "after", sortHeaderClass: "" }), this.emit = e2, this.filteredData = computed(() => 0 === this.state.data.length ? [] : 0 === Object.keys(this.state.filters).length ? this.state.data : function(t2, e3) {
      ...
      for (const a2 of t2) {
        let t3 = true;
        for (const s4 of Object.keys(e3)) if (!C(a2, e3[s4])) {
          t3 = false;
          break;
        }
        t3 && s3.push(a2);
      ...
      return (this.state.sortKey || this.state.customSort) && 0 !== this.state.sortOrder ? (t2 = this.filteredData.value, e3 = this.state.sortKey, s3 = this.state.customSort, a2 = this.state.sortOrder, [...t2].sort((t3, r2) => {
        if ("function" == typeof s3) return s3(t3, r2, a2);
        let l2, o2;
        if (e3 ? "function" == typeof e3 ? (l2 = e3(t3, a2), o2 = e3(r2, a2)) : (l2 = m(t3, e3), o2 = m(r2, e3)) : (l2 = null, o2 = null), null == l2 && (l2 = ""), null == o2 && (o2 = ""), b(l2) && b(o2)) return (l2 - o2) * a2;
    ...
    watch(s2, (t2) => {
      ...
      if (t2.length <= e3 || e3 <= 0 || s3 <= 0) return t2;
  ...
  revealItem(t2) {
    if (!this.paginationEnabled.value) return false;
    let e2;
  ...
  selectRows(t2) {
    for (const e2 of t2) this.selectRow(e2);
  }
  deselectRow(t2) {
  ...
  deselectRows(t2) {
    for (const e2 of t2) this.deselectRow(e2);
  }
  selectAll() {
...
var I = defineComponent({ name: "VTh", props: { sortKey: { type: [String, Function], required: false, default: null }, customSort: { type: [Function, Object], required: false, default: null }, defaultSort: { type: String, required: false, validator: (t2) => ["asc", "desc", null].includes(t2), default: null } }, emits: ["defaultSort", "sortChanged"], setup(e2, { emit: s2, slots: a2 }) {
  const r2 = inject(O);
  if (!e2.sortKey && !e2.customSort) throw new Error("Must provide the Sort Key value or a Custom Sort function.");
  ...
  const n = computed(() => {
    if (!r2.state.hideSortIcons) return function(e3) {
...
var N = defineComponent({ name: "VTPagination", props: { currentPage: { type: Number, required: true }, totalPages: { type: Number, required: true }, hideSinglePage: { required: false, type: Boolean, default: true }, maxPageLinks: { required: false, type: Number, default: NaN }, boundaryLinks: { required: false, type: Boolean, default: false }, directionLinks: { required: false, type: Boolean, default: true } }, setup(t2, { slots: e2, emit: s2 }) {
  const a2 = computed(() => isNaN(t2.maxPageLinks) || t2.maxPageLinks <= 0 ? (() => {
    const e3 = [];
    for (let s3 = 1; s3 <= t2.totalPages; s3++) e3.push({ title: s3.toString(), value: s3 });
    return e3;
  })() : (() => {
    ...
    for (let n2 = r3; n2 <= l3 && !(n2 > t2.totalPages); n2++) e3.push({ title: n2.toString(), value: n2 });
  ...
  return () => {
    ...
    if (t2.hideSinglePage && 1 === t2.totalPages) return h("");
    const y = [];
    if (t2.boundaryLinks) {
    ...
    for (const e3 of a2.value) y.push(d(e3.title, () => r2(e3.value), false, e3.value === t2.currentPage));
    if (t2.directionLinks) {
