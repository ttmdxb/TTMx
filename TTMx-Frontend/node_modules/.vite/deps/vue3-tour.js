...
// node_modules/vue3-tour/dist/vue3-tour.js
var et = {
  onStart: () => {
  },
  onPreviousStep: () => {
...
var Ht = defineComponent({
  ...
  setup(t) {
    const e = t, r = ref(-1), n = computed(() => ({
      ...Ae,
      ...e.options
    })), o = computed(() => ({
      ...et,
      ...e.callbacks
    })), u = computed(() => r.value > -1 && r.value < a.value), p = computed(() => r.value === 0), s = computed(() => r.value === e.steps.length - 1), a = computed(() => e.steps.length), f = computed(() => e.steps[r.value]), l = async (i) => {
      ...
      return v.hasOwnProperty(i) ? v[i] : true;
    };
    return onMounted(() => {
      ...
      const c = resolveComponent("v-step");
      return openBlock(), createElementBlock("div", Nt, [
        renderSlot(i.$slots, "default", {
          ...
          i.steps[r.value] ? (openBlock(), createBlock(c, {
          ...
          }, null, 8, ["step", "is-first", "is-last", "labels", "enabled-buttons", "highlight", "stop-on-fail", "debug"])) : createCommentVNode("", true)
        ])
      ]);
    };
  }
...
var ne = "start";
var ce = "end";
var jt = "clippingParents";
var dt = "viewport";
var le = "popper";
var Ft = "reference";
var tt = de.reduce(function(t, e) {
  return t.concat([e + "-" + ne, e + "-" + ce]);
}, []);
var ht = [].concat(de, [He]).reduce(function(t, e) {
...
var Ut = "write";
var Yt = "afterWrite";
var Kt = [It, Vt, _t, Wt, Mt, Gt, qt, Ut, Yt];
function _(t) {
...
function Xt(t) {
  ...
  Object.keys(e.elements).forEach(function(r) {
    ...
    !$(u) || !_(u) || (Object.assign(u.style, n), Object.keys(o).forEach(function(p) {
      var s = o[p];
      s === false ? u.removeAttribute(p) : u.setAttribute(p, s === true ? "" : s);
    }));
  });
}
function zt(t) {
...
function sr(t) {
  var e = t.state, r = t.options, n = r.gpuAcceleration, o = n === void 0 ? true : n, u = r.adaptive, p = u === void 0 ? true : u, s = r.roundOffsets, a = s === void 0 ? true : s, f = {
...
function lr(t) {
  var e = t.state, r = t.instance, n = t.options, o = n.scroll, u = o === void 0 ? true : o, p = n.resize, s = p === void 0 ? true : p, a = B(e.elements.popper), f = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function wr(t) {
  ...
  if (!e.modifiersData[n]._skip) {
    for (var o = r.mainAxis, u = o === void 0 ? true : o, p = r.altAxis, s = p === void 0 ? true : p, a = r.fallbackPlacements, f = r.padding, l = r.boundary, h = r.rootBoundary, y = r.altBoundary, d = r.flipVariations, O = d === void 0 ? true : d, g = r.allowedAutoPlacements, b = e.options.placement, w = V(b), i = w === b, v = a || (i || !O ? [Ee(b)] : yr(b)), c = [b].concat(v).reduce(function(te, q) {
    ...
    }, []), m = e.rects.reference, x = e.rects.popper, S = /* @__PURE__ */ new Map(), E = true, T = c[0], A = 0; A < c.length; A++) {
    ...
    e.placement !== T && (e.modifiersData[n]._skip = true, e.placement = T, e.reset = true);
  }
}
var Or = {
  name: "flip",
...
function Cr(t) {
  var e = t.state, r = t.options, n = t.name, o = r.mainAxis, u = o === void 0 ? true : o, p = r.altAxis, s = p === void 0 ? false : p, a = r.boundary, f = r.rootBoundary, l = r.altBoundary, h = r.padding, y = r.tether, d = y === void 0 ? true : y, O = r.tetherOffset, g = O === void 0 ? 0 : O, b = ve(e, {
    boundary: a,
    rootBoundary: f,
    padding: h,
    altBoundary: l
...
function Nr(t, e, r) {
  ...
  We(u)) && (s = $r(e)), $(e) ? (a = ae(e, true), a.x += e.clientLeft, a.y += e.clientTop) : u && (a.x = _e(u))), {
        ...
        if (!y) {
          ...
          if (lt(i, v)) {
            l.rects = {
              ...
              popper: Fe(v)
            }, l.reset = false, l.placement = l.options.placement, l.orderedModifiers.forEach(function(A) {
...
var _r = [pr, Pr, ur, Qt, Tr, Or, Lr, or, Sr];
var Wr = Vr({
  defaultModifiers: _r
});
var Mr = function(e, r, n, o) {
  return e /= o / 2, e < 1 ? n / 2 * e * e + r : (e--, -n / 2 * (e * (e - 2) - 1) + r);
};
var pt = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
  return typeof t;
} : function(t) {
...
var Gr = function() {
  ...
  function b() {
    window.scrollTo(0, r + s), e && p && (e.setAttribute("tabindex", "-1"), e.focus()), typeof y == "function" && y(), f = false;
  }
  function w(i) {
    var v = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    switch (a = v.duration || 1e3, o = v.offset || 0, y = v.callback, u = v.easing || Mr, p = v.a11y || false, r = d(), typeof i > "u" ? "undefined" : pt(i)) {
      case "number":
        e = void 0, p = false, n = r + i;
        break;
      case "object":
        e = i, n = O(e);
        break;
...
var Kr = ["innerHTML"];
var Xr = { class: "v-step__content" };
var zr = ["innerHTML"];
var Qr = { key: 1 };
var Jr = { class: "v-step__buttons" };
var Zr = defineComponent({
  ...
  setup(t, { emit: e }) {
    const r = t, n = e, o = () => (r.skip || r.stop)(), u = () => (r.finish || r.stop)(), s = ((i) => {
      ...
      return v & 4294967295;
    })(r.step.target), a = document.querySelector(r.step.target), f = computed(() => ({
      ...Dt,
      highlight: r.highlight,
      enabledButtons: Object.assign({}, r.enabledButtons),
      ...r.step.params
      // Then use local step parameters if defined
    })), l = computed(() => !r.step.target), h = ref(null), y = () => {
    ...
    }, w = (i) => f.value.enabledButtons.hasOwnProperty(i) ? f.value.enabledButtons[i] : true;
    return onMounted(y), onUnmounted(b), (i, v) => (openBlock(), createElementBlock("div", {
      class: normalizeClass([{ "v-step--sticky": l.value }, "v-step"]),
      id: "v-step-" + unref(s),
      ref_key: "VStep",
      ref: h
    }, [
      renderSlot(i.$slots, "header", {}, () => [
        i.step.header ? (openBlock(), createElementBlock("div", Yr, [
          i.step.header.title ? (openBlock(), createElementBlock("div", {
            key: 0,
            innerHTML: i.step.header.title
          }, null, 8, Kr)) : createCommentVNode("", true)
        ])) : createCommentVNode("", true)
      ]),
      renderSlot(i.$slots, "content", {}, () => [
        createBaseVNode("div", Xr, [
          i.step.content ? (openBlock(), createElementBlock("div", {
            key: 0,
            innerHTML: i.step.content
          }, null, 8, zr)) : (openBlock(), createElementBlock("div", Qr, "props is a demo step! The id of props step is " + toDisplayString(unref(s)) + " and it targets " + toDisplayString(i.step.target) + ".", 1))
        ])
      ]),
      renderSlot(i.$slots, "actions", {}, () => {
        ...
        return [
          createBaseVNode("div", Jr, [
            !i.isLast && w("buttonSkip") ? (openBlock(), createElementBlock("button", {
              key: 0,
              onClick: withModifiers(o, ["prevent"]),
              class: "v-step__button v-step__button-skip"
            }, toDisplayString((c = i.labels) == null ? void 0 : c.buttonSkip), 1)) : createCommentVNode("", true),
            !i.isFirst && w("buttonPrevious") ? (openBlock(), createElementBlock("button", {
              key: 1,
            ...
            }, toDisplayString((m = i.labels) == null ? void 0 : m.buttonPrevious), 1)) : createCommentVNode("", true),
            !i.isLast && w("buttonNext") ? (openBlock(), createElementBlock("button", {
              key: 2,
              onClick: v[1] || (v[1] = withModifiers(
                //@ts-ignore
                (...E) => i.nextStep && i.nextStep(...E),
                ["prevent"]
              )),
              class: "v-step__button v-step__button-next"
            }, toDisplayString((x = i.labels) == null ? void 0 : x.buttonNext), 1)) : createCommentVNode("", true),
            i.isLast && w("buttonStop") ? (openBlock(), createElementBlock("button", {
              key: 3,
              onClick: withModifiers(u, ["prevent"]),
              class: "v-step__button v-step__button-stop"
            }, toDisplayString((S = i.labels) == null ? void 0 : S.buttonStop), 1)) : createCommentVNode("", true)
          ])
        ];
      }),
      createBaseVNode("div", {
        class: normalizeClass(["v-step__arrow", { "v-step__arrow--dark": i.step.header && i.step.header.title }]),
        "data-popper-arrow": ""
      }, null, 2)
    ], 10, Ur));
  }
...
//# sourceMappingURL=vue3-tour.js.map
